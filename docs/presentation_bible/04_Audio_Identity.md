...
These standards give principles and craft direction rather than inventing biography. The canon documents establish who each character is; this document builds their sound on that foundation and frames any specific creative direction as guidance for the craft, not as settled backstory.
...
Casting is the single most important act in building each character's audio identity, because the voice is the strongest and most human recognition cue in the game.

- Cast the person, not the trait. Casting seeks an actor who can inhabit a complete person, with the character's identity facts as meaningful context rather than as a checklist. Every recurring character is a complete person first.
...
Accent is a powerful, immediate recognition cue and a marker of a person's history, and it is handled with authenticity and care.

- Authentic and specific. Accents are grounded in real speech communities and rendered by performers who carry them or who are directed with genuine reference and consultation, never as generic or exaggerated shorthand.
- Accent as history, not label. An accent conveys where a person has lived and moved, as one honest facet of a complete person, and is never used to signal virtue, threat, or status.
- Range across the ensemble. The cast carries a natural range of accents so the community sounds like the breadth of humanity, with no accent treated as the neutral default.
- Stability and change. A character's accent is stable across the franchise, and any change over a long story is a deliberate, documented continuity choice.
...
- Talia Rusk is Native and Two-Spirit, and her nation, culture, and community are deliberately undeveloped and to be developed thoughtfully with Indigenous cultural consultation. No specific nation, language, or culturally coded accent is invented or imposed for her.
- Until that development happens with proper consultation, Talia's accent is handled with respect for that specificity and without a placeholder, in partnership with the performer and cultural advisors rather than assigned from outside.
...
- Samira Kade communicates through signed language and live text via her sleeve projector, and her cadence lives in the rhythm of her signing and the pacing of the text she projects.
- Her communication cadence is authored as fully expressive, with its own timing, emphasis, and personality, and is a recognition cue in its own right.

### Cadence Standards for Mira Ives

- Mira communicates through her augmentative and alternative communication system, and her cadence includes the rhythm and timing of how she composes and delivers messages through that system.
- Her cadence is authored with respect for how an autistic child with attention-deficit hyperactivity disorder communicates, including her own tempo and patterns, and is never corrected toward a neurotypical norm.

## Walking Sound Standards

Footsteps are one of the richest recognition cues in a sound-first game, and each character has a distinct walking signature built from weight, pace, rhythm, footwear, gait, and any mobility aid.

- Distinct gaits. Each character's walk is individual and consistent, so the player can identify who is approaching before they speak, consistent with recognition through movement and body language.
- Weight, surface, and space. Footstep sound reflects a character's build and footwear, the surface underfoot, and the acoustic identity of the location, so movement always situates a character in a place.
- Gait as character and state. A walk carries personality and current state, quickening in urgency, easing at rest, or changing with fatigue or pain, and these changes are meaningful.
- Aids are part of the walk. Where a character uses a prosthetic, a chair, or a cane, that aid is an integral, honest part of their movement signature and is addressed in its own section below.
...
- Talia Rusk is a lower-limb amputee who uses a prosthetic limb, and her gait includes a distinctive prosthetic footfall that is a strong recognition cue.
- Her walk is authored as steady and capable, the movement of a protector, with the prosthetic's sound treated as an ordinary, dignified part of how she moves. The specifics of the prosthetic's sound are covered under prosthetics below, and no aspect of it implies a specific nation or culture.
...
- Rowan Ives moves as an experienced maintenance worker who lives with chronic pain and arthritis, and his gait may carry the honest weight of managing pain across a shift, without being staged as suffering.
- Jonah Briggs moves as the calm, steady presence who reads out priorities, with a measured, reliable step.
- For the Vale System, walking rhythm and preferred stance change naturally with whoever is fronting, so the gait itself is a recognition signal for the current member on one constant body.
- Doctor Soren Qadir moves by chair rather than on foot, and his movement signature is covered under wheelchair sound standards below.

## Equipment Sound Standards
...
### Equipment Sound Standards for Doctor Samira Kade

- Doctor Samira Kade's presence in a bay is the soft mechanical whisper of her sleeve projector, one of the signature sounds of the game and a reliable cue that she has arrived.
- The projector's whisper is authored as gentle, precise, and consistent, an elegant standard-equipment sound that accompanies her signed and text communication and that identifies her before she is seen.

### Equipment Sound Standards for Mara Chen

- Mara Chen's engineering helmet, whose navigation faceplate turns visual data into audio and tactile cues, has its own operating sound that is part of her recognition signature together with her listening gait.
- The helmet's sound is authored as expert engineering equipment, ordinary and dependable, so that the combination of helmet sound and listening gait marks Mara clearly and with dignity.

### Equipment Sound Standards for the Working Cast
...
Cloth and worn gear make sound, and these sounds are a subtle but genuine recognition layer that also communicates a character's state and situation.
...
- The uniform is part of the constant body and does not change with fronting, so the base clothing sound of the Vale System is constant.
- What varies with fronting is how the body moves within that clothing, since posture, gait, and gesture change with the current member, and the clothing sound follows that movement as a supporting recognition layer rather than a leading one.
...
For a wheelchair user, the chair is an integral, expressive part of the movement signature and is designed to sound capable, personal, and reliable rather than clinical.
...
The white cane is a source of rich, information-bearing sound, and cane technique is authored as skilled, expressive, and specific, both as a recognition cue for any character who uses a cane and as a supported way for players to move.
...
- Sound carries state. The prosthetic's footfall reflects pace, effort, and situation, quickening in urgency and easing at rest, as part of the character's honest movement.
- Reliability under stress. The prosthetic continues to sound dependable in emergencies, consistent with accessibility devices being shown as reliable equipment.
...
- Mara Chen's signature sounds are the sounds of engineering work by someone who describes systems as sounds, paired with her listening gait and helmet, so her presence in a machine space is unmistakable.
- Doctor Samira Kade's signature sound is the soft whisper of her sleeve projector within the acoustic identity of a medical bay.
...
- The Visual Design Standards are the companion to this document; audio identity leads, and the visual standards must always agree with the world the audio establishes.
- The Audio Bible governs sound as the primary renderer, perspective audio, the dynamic and spatial soundscape, acoustic identity of locations, silence as a tool, and sound as progression, and no audio identity standard may violate it.
- The Accessibility Bible governs accessibility as standard equipment, configuration by experience rather than diagnosis, the tactile language, captions and text for information that must never depend on sound alone, and support for every listening and movement method, and no audio identity standard may violate it.

## Open Development Items for Audio Identity

Two items are deliberately left open in the Character Identity Map and are carried here so that audio direction respects that openness rather than closing it prematurely.

- Talia Rusk is the Two-Spirit character, and Two-Spirit is a culturally specific Indigenous identity. Her nation, culture, and community are to be developed thoughtfully, ideally with Indigenous cultural consultation. Until then, no accent, language, chant, or culturally coded sound is invented or imposed for her, and her audio identity is developed in partnership with Indigenous performers and advisors rather than assigned from outside.
- Mira Ives is a child who is genderfluid and uses she and they, and she is still growing into her own understanding. The qualities of her AAC voice and her overall audio presentation are kept respectful and non-fixed and are open to development as the character and the story mature.
