# Player Identity and Character Presentation Bible

This is the definitive cross-discipline reference for how people are presented in Resonance: Fractured Frequency. It exists so that artists, animators, interface designers, audio designers, writers, and gameplay programmers all present the same person the same way, across every channel, from the first five minutes of play to the fiftieth hour. It is deliberately deep, and it is split into numbered parts so that it stays readable by screen readers and maintainable over time.
...
- The Character Identity Map, in 00_Character_Identity_Map.md, records the locked identity of every recurring character and confirms that the cast satisfies the representation rules.
...
Two items are deliberately left open across the whole bible and must be developed with care rather than invented. The specific nation, culture, and community of Security Lead Talia Rusk, the Two-Spirit character, are to be developed thoughtfully, ideally with Indigenous cultural consultation. The gender expression and pronouns of Mira Ives, a genderfluid child who uses she and they, are open to development as the character grows.
