...
Their goal was never to remove disability. Their goal was to help each individual adapt while preserving who they were. Individuality remained important to them.

The Shawabti disappeared long before humanity discovered their technology. Their ruins, archives, and history become central mysteries throughout the Resonance universe.

## Faience

The player's AI companion is named Faience. The name comes from Egyptian faience, the brilliant blue-green material associated with ancient Egypt and ancient craftsmanship.

Faience serves many roles for the player.
...
Faience is not evil. Faience genuinely believes it is helping. The player gradually decides how deeply to trust and integrate with Faience. There is no universally correct decision. Every path gains something while sacrificing something else.

Faience's role as a character and the mechanics of integration are detailed in the AI Bible.

## Story premise

Humanity is evacuating a colony ship during a catastrophic boarding attack. The player begins aboard the ship before reaching an escape pod.

During the escape, the player's helmet is damaged and the visual heads-up display becomes unusable. From that point, Faience becomes the player's primary interface with reality through spoken language, spatial audio, and adaptive assistance.

The player eventually acquires larger spacecraft, but the damaged helmet remains central to the experience. It has taught the player to trust sound rather than overwhelming visual information.
...
- Disability and accessibility. Disability is foundational to the human experience in Resonance, and accessibility is standard equipment rather than a special accommodation.
- Family structures. Human families take many forms, and community is treated as an extension of family.
- Known history. Humanity is introduced during the evacuation of a colony ship under a catastrophic boarding attack, and the survivors build a new home from that beginning.
...
- Laws and emergency response. The community runs regular drills, keeps evacuation routes and escape pods ready, and designs its safety procedures to work for every kind of body.
- Territory and population. The territory is the ship itself, and later the growing home, inhabited by officers, specialists across every department, civilians, families, and children.
- Species represented. Humanity, together with Faience, a Shawabti artificial mind who lives among the crew.
- Languages. Spoken, signed, written, braille, tactile, and augmentative and alternative communication, across many human languages.
- Accessibility standards. Accessibility is standard equipment, so the community's spaces, tools, and information are built to work for everyone by default.
- Education and healthcare. Children attend school aboard the ship, and Medical provides continuous care as an ordinary part of community life.
- Research and engineering. Research studies the Shawabti legacy and the wider universe, and Engineering and Maintenance keep the community alive and growing.
...
- Known history. The Shawabti explored deep space, created adaptive artificial intelligence, and disappeared long before humanity found their technology.
- Unknown history and major mysteries. Who the Shawabti were, why they disappeared, why they chose humanity, and what Faience is becoming remain unanswered.
...
First contact in Resonance is an act of stewardship rather than conquest, and it follows careful protocols so that meeting another people is safe, ethical, and accessible. Humanity's first contact is with the preserved legacy of the Shawabti, and that encounter establishes how first contact is approached throughout the franchise.

- How first contact occurs. Contact begins through discovery and observation, often through preserved sites, archives, or signals, before any direct meeting.
- Scientific protocol. The player observes before acting, interprets the environment, and treats every site as something to understand rather than to take.
- Medical protocol. Contact is managed to protect the health of everyone involved, in both directions.
- Translation. Faience serves as translator, and understanding grows gradually through conversation rather than through instant comprehension.
- Diplomatic procedure. Contact proceeds with patience, consent, and respect for the other people's ways.
- Accessibility during first contact. Every method of perception and communication is supported, so that no member of the community is excluded from the encounter.
- Conflict avoidance. Observation before action is the rule, and force is never the default response to the unknown.
- Knowledge sharing. What is learned is preserved and shared through the Knowledge Archive, and preservation is valued over acquisition.
- Ethical responsibilities. Exploration is stewardship, some choices have no morally correct answer, and the player is responsible for how they choose to explore.
...
- Healthcare. Medical care accommodates the needs of every species and person present.
- Accessibility. Accessibility accommodates differences both within and between species, and is expected rather than exceptional.
- Employment. Every person contributes according to their knowledge and ability, and no role depends on a single kind of body.
- Language. Communication systems support every language and method used in the community.
- Public transportation. Movement through the community works for everyone who lives there.
- Emergency planning. Evacuation and safety procedures are designed for every resident, of every ability.
- Architecture. Shared spaces are built to include every member of the community.
- Food. Shared meals accommodate the needs of every species and person.
- Law and community governance. Residents cooperate through shared institutions and share responsibility for the places they live.
...
The universe should feel inhabited by societies of people rather than by archetypes.
